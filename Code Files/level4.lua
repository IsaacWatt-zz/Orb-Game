...
function level4:init()
	...
	self:addChild(wall.new(self.world, 130, 275, 5, 200, true, 60))
	self:addChild(wall.new(self.world, 350, 110, 5, 50, true, 90))
	...
	-- bricks
	self:addChild(brick.new(self.world,375, 300 - 25 * 1))
	self:addChild(brick.new(self.world,375, 300 - 25 * 2))
	self:addChild(brick.new(self.world,375, 300 - 25 * 3))
		
	-- orb
	self:addChild(orb.new(self.world,150, screenH - 20, "images/orb.png", 10))
	self:addChild(orb.new(self.world,427, 100, "images/yelloworb.png", 20))
	self:addChild(orb.new(self.world,350,90, "images/redorb.png", 30))
		
	-- ice
	self:addChild(ice.new(self.world, 350, 95, .4,.4,.2))
		
	-- sponge
	self:addChild(sponge.new(self.world, 240,302, 0.16 ))
...
function level4:onEnterFrame() 
	...
	for i = 1, self:getNumChildren() do
		...
		if sprite.body then
			...
			if self.points == 60 and conf.onLevel == 4 then 	
				conf.onLevel = 5
...
function level4:onBeginContact(event)
