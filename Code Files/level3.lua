...
function level3:init()
	...
	self:addChild(wall.new(self.world,260, 215, 5, 200, wallColour, 90))
	...
	-- bricks
	self:addChild(brick.new(self.world,180, screenH - 20))
	self:addChild(brick.new(self.world,280, screenH - 20))
		
	-- ice
	self:addChild(ice.new(self.world, 240, 150, .3, 0.8, .35))
	self:addChild(ice.new(self.world, 180, screenH - 60, .4,0.4,.35))
	self:addChild(ice.new(self.world, 280, screenH - 60, .4,.4,.35))
	self:addChild(ice.new(self.world, 185,200, .4, 0.45, .35))
	self:addChild(ice.new(self.world, 295,200, .4, 0.45, .35))
	self:addChild(ice.new(self.world, 425, screenH - 105, .3, 0.3, 1.5))
	
	-- orb
	self:addChild(orb.new(self.world,235, screenH - 20, "images/orb.png", 10))
	self:addChild(orb.new(self.world,427, 100, "images/yelloworb.png", 20))
	self:addChild(orb.new(self.world,235,200, "images/redorb.png", 30))
...
function level3:onEnterFrame() 
	...
	for i = 1, self:getNumChildren() do
		...
		if sprite.body then
			...
			if self.points == 60 and conf.onLevel == 3 then 	
				conf.onLevel = 4
				sceneManager:changeScene("start", conf.transitionTime * 3, conf.transition, conf.easing)  
			elseif  self.points == 60 and conf.onLevel ~= 3 then 
				sceneManager:changeScene("start", conf.transitionTime * 3, conf.transition, conf.easing) 
			end
...
function level3:onBeginContact(event)
