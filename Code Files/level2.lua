...
function level2:init()
	...
	self:addChild(wall.new(self.world, 400, 200, 5, 100, true, 90))
	self:addChild(wall.new(self.world, 390, 290, 5, 40, true, 180))
	self:addChild(wall.new(self.world, 195, 295, 5, 40, true, 30)) -- pointing right
	self:addChild(wall.new(self.world, 255, 295, 5, 40, true, -30)) -- pointing left
	...
	-- bricks
	self:addChild(brick.new(self.world,375, 200 - 25 * 1))
	self:addChild(brick.new(self.world,375, 200 - 25 * 2))
	self:addChild(brick.new(self.world,375, 200 - 25 * 3))
	self:addChild(brick.new(self.world, 435, 285))
		
	-- orb
	self:addChild(orb.new(self.world,225, screenH - 20, "images/orb.png", 10))
	self:addChild(orb.new(self.world,427, 100, "images/yelloworb.png", 20))
	self:addChild(orb.new(self.world,435,205, "images/redorb.png", 30))
...
function level2:onEnterFrame() 
	...
	for i = 1, self:getNumChildren() do
		...
		if sprite.body then
			...
			if self.points == 60 and conf.onLevel == 2 then 	

				conf.onLevel =  3
				sceneManager:changeScene("start", conf.transitionTime * 3, conf.transition, conf.easing)  

			elseif  self.points == 60 and conf.onLevel ~= 2 then 
				sceneManager:changeScene("start", conf.transitionTime * 3, conf.transition, conf.easing) 
			end
...
function level2:onBeginContact(event)
